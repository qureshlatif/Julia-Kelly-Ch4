...
data <- list("Y","nplot","nyear","n.visits","EarlInf.z","MidInf.z","snag.z","QMD.z","EarlInf0","EarlInf.low",
             "EarlInf.high","MidInf.low","MidInf.mod","MidInf.high","snag.low","snag.mod","snag.high","QMD.low",
             "QMD.mod","QMD.high")
...
parameters <- c("p","beta0","beta1","beta.EarlInf","beta.MidInf","beta.snag","beta.QMD",
                "test","psi.EI","psi.MI","psi.snag","psi.QMD","psi.fs","Z")
