...
#mod <- loadObject("Mod_NoPers_EInfMInfSnagQMD_sim1")
#mod <- loadObject("Mod_NoPers_EInfMInfSnagQMD_sim2")
mod <- loadObject("Mod_NoPers_EInfMInfSnagQMD_sim3")
...
save_plot("Plots_sim3.jpeg", p, ncol = 3, nrow = 3, dpi=600) 
